             ...
             os:[
                 {
                     ...
                     title:"Ubuntu",
                     text:"J'ai une bonne metrise du systeme Ubuntu  <strong> (Systeme basé sur Debian) </strong>  "
                 },
                 {
                     id:2,
                     img:"assets/img/rh.png",
                     title:"RedHat",
                     text:"J'ai une bonne metrise du systeme RedHat  "
                 },
                 {
                     id:3,
                     img:"assets/img/win.png",
                     title:"Windows",
                     text:"J'ai une bonne metrise du systeme Windows  "
                 },
             ]
             ,
             sgbd:[
                 {
                     ...
                     title:"SGBG Oracle",
                     text:"J'ai une bonne metrise du SGBD  <strong> ORACLE </strong>  "
                 },
                 {
                     id:2,
                     img:"assets/img/mng.png",
                     title:"SGBG No SQL MongoDB",
                     text:"J'ai une bonne metrise du SGBD  <strong> MongoDB </strong>  "
                 },
                 {
                     id:3,
                     img:"assets/img/pg.png",
                     title:"SGBG PostgreSQL",
                     text:"J'ai une bonne metrise du SGBD  <strong> PostgreSQL </strong>  "
                 },
                 {
                     id:4,
                     img:"assets/img/sqlserver.jpg",
                     title:"SGBG Microsoft SQL Server",
                     text:"J'ai une bonne metrise du SGBD  <strong> Microsoft SQL Server </strong>  "
                 },
             ]
             ,
             tools:[
             ...
             lang:[
                 {
                     ...
                     title:"java",
                     text:"J'ai une bonne metrise du langage Java <strong>Maven</strong> et <strong>Checkstyle</strong><br/> qui est un outil de contrôle de code, utilisé en développement de logiciel. Il permet de vérifier le style d'un code source écrit en langage Java "
                 },
                 {
                     id:2,
                     img:"assets/img/C++.png",
                     title:"c++",
                     text:"J'ai une bonne metrise du langage C++"
                 },
                 {
                     id:3,
                     img:"assets/img/pyqt.png",
                     title:"Qt",
                     text:"J'ai une bonne metrise de Qt designer pour les application Desktop"
                 },
                 {
                     id:4,
                     img:"assets/img/r.jpeg",
                     title:"R",
                     text:"J'ai une bonne metrise du langage statistique R "
                 },
                 {
                     id:5,
                     img:"assets/img/c.png",
                 ...
                 },
                 {
                     ...
                     title:"Django (Python)",
                     text:"J'ai une bonne metrise du framework web django du langage python <br/> et la conception des API REST en utilisant <strong> django-restframework </strong> et la modelisation en utilisant <strong>l'ORM django </strong> "
                 },
                 {
                     id:7,
                     img:"assets/img/python.png",
                     title:"Python",
                     text:"J'ai une bonne metrise du langage python  "
                 },
                 {
                     id:8,
                     img:"assets/img/mp.png",
                     title:"Librairie Open Mp",
                     text:"J'ai une bonne metrise de la pribrairie du calcule haut performance OPEN-MP  "
                 },
                 {
                     id:9,
                     img:"assets/img/mpi.jpeg",
                     title:"Librairie Open Mpi",
                     text:"J'ai une bonne metrise de la pribrairie du calcule haut performance OPEN-MPI  "
                 },
                 {
                     id:10,
                     img:"assets/img/react.png",
                     title:"Librairie ReactJS",
                     text:"J'ai une bonne metrise de la pribrairie ReactJS en utilisant les composant basés sur des classes <strong> (class based components)</strong>  "
                 },

                 {
                     ...
                     title:"React Native",
                     text:"J'ai une bonne metrise de React Native <strong> (développement des applications mobiles multiplateforme(IOS et Android) )</strong>  "
                 },
                 {
                     id:12,
                     img:"assets/img/spring.png",
                     title:"Spring Boot",
                     text:"J'ai une bonne metrise du framework web spring boot (Java) en plus de l'ORM  <strong>(Hibernate JPA) </strong>  "
                 },
                 {
                     id:13,
                     img:"assets/img/vuejs.png",
                     title:"VueJS",
                     text:"J'ai une bonne metrise du framework web VueJS  <strong>(pour le frontend) </strong>  "
                 },
                 {
                     id:14,
                     img:"assets/img/shell.png",
                     title:"BASH",
                     text:"J'ai une bonne metrise du <strong>(SHELL) </strong>  sous linux "
                 },
                 {
                     id:15,
                     img:"assets/img/hadoop.png",
                     title:"Hadoop",
                     text:"J'ai une bonne metrise de <strong>Hadoop </strong>  est un framework libre et open source écrit en Java destiné à faciliter la création d'applications distribuées et échelonnables permettant aux applications de travailler avec des milliers de nœuds et des pétaoctets de données. Ainsi chaque nœud est constitué de machines standard regroupées en grappe. "
                 },
